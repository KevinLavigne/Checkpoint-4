...
function Login() {
  ...
  return (
    <form className="flex flex-col justify-center mb-10  text-center  ">
      <div className="rounded-md shadow-md border-2 bg-indigo m-3 p-3 w-[100%] md:w-[70%] lg:w-[50%]  mx-auto mt-32 space-y-4 flex flex-col justify-center">
        <p className="text-Red font-bold text-2xl">Connexion</p>
        <label htmlFor="Email">
          <input
            type="email"
            placeholder="Email"
        ...
        <div className="px-5 mt-3 flex flex-row justify-between">
          ...
          >
            {msg && <p>{msg}</p>}
            <p className="text-Red font-bold text-2xl">Se connecter</p>
          </button>
        </div>
      </div>
    </form>
